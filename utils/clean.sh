...
rm -f src/config/fapalien-config.h
...
rm -rf test_bitcoin.coverage/ fapalien-gtest.coverage/ total.coverage/
...
clean_exe src/fapalien-cli
clean_exe src/fapaliend
clean_exe src/fapalien-gtest
clean_exe src/fapalien-tx
clean_exe src/test/test_fapalien
clean_exe src/test/test_fapalien_fuzzy
...
clean_dep . src/config/fapalien-config.h.in
