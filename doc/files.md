...
* fapalien.conf: contains configuration settings for fapaliend or fapalien-qt
* fapaliend.pid: stores the process id of fapaliend while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by fapaliend or fapalien-qt
