...
This document provides guidelines for internationalization of the Fapalien Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fapalien_en.ts` remains unchanged.
