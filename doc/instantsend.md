...
This mechanism has been integrated into Bitcore-Node-Fapalien which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fapalienchain/insight-api-fapalien#web-socket-api](https://github.com/fapalienchain/insight-api-fapalien#web-socket-api)
* API: [https://github.com/fapalienchain/insight-api-fapalien#instantsend-transactions](https://github.com/fapalienchain/insight-api-fapalien#instantsend-transactions)
