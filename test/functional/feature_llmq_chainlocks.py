...
from test_framework.test_framework import FapalienTestFramework
...
class LLMQChainLocksTest(FapalienTestFramework):
    def set_test_params(self):
        self.set_fapalien_test_params(6, 5, fast_dip3_enforcement=True)
