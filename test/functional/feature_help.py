...
"""Verify that starting fapaliend with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fapaliend with -h for help text")
        ...
        self.log.info("Start fapaliend with -version for version information")
