Contributing to Fapalien Core
============================

The Fapalien Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/fapalienchain/fapalien/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Fapalien Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Fapalien
Network Protocol consensus changes.

Whether a pull request is merged into Fapalien Core rests with the project merge
...
Patches that change Fapalien consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fapalien consensus, it must have been
...
The review process is normally fairly responsive on the Fapalien Core repository, however
...
The project leader is the release manager for each Fapalien Core release.
