...
//! Interface for the src/evo part of a fapalien node (fapaliend process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a fapalien node (fapaliend process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a fapalien node (fapaliend process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a fapalien node (fapaliend process).
class Node
{
public:
    virtual ~Node() {}
