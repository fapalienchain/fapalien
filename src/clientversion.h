...
#error Client version information missing: version is not defined by fapalien-config.h or in any other way
#endif
...
/**
 * fapaliend-res.rc includes this file, but it cannot cope with real c++ code.
