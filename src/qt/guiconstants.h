...
/* FapalienGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* FapalienGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Fapalien"
#define QAPP_ORG_DOMAIN "fapalienchain.com"
#define QAPP_APP_NAME_DEFAULT "Fapalien-Qt"
#define QAPP_APP_NAME_TESTNET "Fapalien-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Fapalien-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Fapalien-Qt-regtest"
