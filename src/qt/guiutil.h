...
/** Utility functions used by the Fapalien Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "fapalien:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load fapalien specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a fapalien specific theme is activated (light/dark).*/
