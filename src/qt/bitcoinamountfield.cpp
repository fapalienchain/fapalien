...
public:
    ...
    QSize minimumSizeHint() const
    {
        ...
        int h = 0;
        int w = fm.width(BitcoinUnits::format(BitcoinUnits::FAP, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
        w += 2; // cursor blinking space
        w += GUIUtil::fapalienThemeActive() ? 24 : 0; // counteract padding from css
        return QSize(w, h);
    }
