    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  fapalien-qt [command-line options]                     \n";
...
All the Fapalien in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 FAP, 0.01 FAP, 0.1 FAP, 1 FAP and 10 FAP -- sort of like the paper money you use every day.</li> \
